...
typedef struct sym  // Структура, в которой будет храниться значение одного из пришедших символов. С помощью typedef вводим новый тип - symbol. Им мы обозначаем struct sym
{
